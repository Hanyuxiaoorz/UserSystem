...
public class Canstants {
    ...
    //注册的其他状态值
    public static final int REGIST_EXIST = 2;//该信息已经被注册
    public static final int REGIST_NULL = 3;//注册信息未填写完整
    public static final int REGIST_STYLE_FAIL = 4;//存在格式错误
    public static final int REGIST_VCODE_FAIL = 5;//验证码不正确
